...
export const PERMISSIONS = Object.freeze({
  ...
  EVENTS_CHANGE_STATUS_OWN: [ROLES.ORGANIZER, ROLES.ADMIN],
  EVENTS_MANAGE_ANY: [ROLES.ADMIN],
  TICKETS_CREATE: [ROLES.USER, ROLES.ORGANIZER, ROLES.ADMIN],
  TICKETS_READ_EVENT_OWN: [ROLES.ORGANIZER, ROLES.ADMIN],
  TICKETS_CANCEL_ANY: [ROLES.ADMIN],
